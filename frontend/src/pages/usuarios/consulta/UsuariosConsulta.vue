    ...
    <main>
        ...
        <section class="right" data-aos="fade-left">
            <div class="top" data-aos="fade-left">
                ...
                <span>| Usuários Consulta</span>
                <div class="actions">
                    <div class="button">
                        <button @click="voltar()" class="btn-padrao">Voltar</button>
                    </div>
                    <div class="button">
                        <button @click="DirecionarPaginaUsuariosCadastro()" class="btn-padrao">Novo</button>
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        DirecionarPaginaUsuariosCadastro: function() {
...
<style src="./UsuariosConsulta.scss" lang="scss" scoped>